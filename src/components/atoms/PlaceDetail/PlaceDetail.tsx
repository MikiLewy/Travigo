...
import { Day, Price, PriceWrapper } from './PlaceDetail.styles';
...
const PlaceDetail: React.FC<PlaceDetailProps> = ({ isCard, isSchelude, name, region, date, imageUrl, rating, price }) => {
  return (
    <>
